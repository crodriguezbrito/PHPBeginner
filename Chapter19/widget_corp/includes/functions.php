<?php
	...
	//funcion errores de formularios
	...
	function find_default_page_for_subject($subject_id){
		...
		if($first_page = mysqli_fetch_assoc($page_set)){ //con esto si no esta dentro de un while se queda con el primer elemento del array asociativo, en este caso la primera page de un subject
			return $first_page;
		}else{
			return null;
		}
	...
	function find_all_admins(){
		...
		confirm_query($admin_set); //mirar funcion en includes/functions.php
		return $admin_set;
	}	
?>